    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 col-md-12 text-center pt-md-5">
          <h1 class="text-white mb-2">Health Care</h1>
          <ol class="breadcrumb mb-0 p-0">
            <li class="breadcrumb-item"><a href="{{ route("welcome") }}"><i class="fa fa-home pr-2"></i>Welcome</a></li>
            <li class="breadcrumb-item active"><span>Health Care</span></li>
          </ol>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-6 mb-4 mb-md-0">
          <div class="position-relative pb-md-0 h-100">
            <img class="img-fluid b-radius pb-sm-6" src="{{URL::asset('/storage/'.$health_care->health_care_image)}}" alt="mission image">
          </div>
        </div>
        <div class="col-md-6">
          {!! $health_care->health_care_body !!}
        </div>
      </div>
